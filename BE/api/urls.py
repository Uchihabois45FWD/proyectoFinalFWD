...
urlpatterns = [
    ...
    path("eliminar-evento/<int:pk>/", EventoDetailView.as_view(), name="eliminar-evento"),
    path("actualizar-evento/<int:pk>/", EventoDetailView.as_view(), name="actualizar-evento"),
